...
public final class MainActivity extends Activity {
  ...
  @Override public void onCreate(Bundle b){platformSwipeDismiss=PodRuntimeView.requestPlatformSwipeDismiss(this);super.onCreate(b);pod=new PodRuntimeView(this,"wearos-watch");pod.captureNotificationIntent(getIntent());setContentView(pod);if(PodRuntimeView.ACTION_COMPANION_SETTINGS.equals(getIntent().getAction()))pod.post(pod::showCompanionSettings);}
